...
class msDB { // define the properties
	public $db, $message;
	protected $sql_query, $sql_array;
	// initialize class
	...
	protected function execSQL($sql_query, $sql_array) {
		...
		try {
			...
			$this->message = "Failed to execute " . $sql_query . "---->" . $e . "--->" . $this->db->ErrorMsg ();
		}
		return $result;
	}
	/**
	...
	public function executeSQL() {
		...
		try {
			...
			$this->message = "Failed to execute " . $this->sql_query . "---->" . $e . "--->" . $this->db->ErrorMsg ();
		}
		return $result;
	}
